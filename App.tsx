...
import TransportTheory from './TransportTheory';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#fcfcfd] font-sans text-slate-900 selection:bg-orange-100 selection:text-orange-900 overflow-x-hidden">
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 pb-32">
              ...
              >
                ...
                <div className="w-16 h-16 bg-blue-600/20 rounded-3xl flex items-center justify-center text-blue-400 shadow-xl rotate-3 group-hover:rotate-12 transition-all">
                   <BookOpen className="w-8 h-8" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-3xl sm:text-4xl font-black italic uppercase tracking-tighter text-blue-400">Դասեր և Կանոններ</h3>
                  <p className="text-white/60 font-bold italic leading-tight text-base sm:text-lg">Subir, Tomar, Montar, Bajar և խոնարհումներ։</p>
                </div>
                <div className="flex items-center gap-2 text-blue-400 font-black uppercase text-xs tracking-widest pt-4">
              ...
              >
                <div className="w-16 h-16 bg-orange-600/20 rounded-3xl flex items-center justify-center text-orange-600 shadow-xl -rotate-3 group-hover:rotate-6 transition-all">
                   <Trophy className="w-8 h-8" />
                </div>
                <div className="space-y-2">
                  <h3 className="text-3xl sm:text-4xl font-black italic uppercase tracking-tighter text-slate-900">Գոռ vs Գայանե</h3>
                  <p className="text-slate-400 font-bold italic leading-tight text-base sm:text-lg">Ստուգիր գիտելիքներդ մրցութային խաղի միջոցով։</p>
                </div>
                <div className="flex items-center gap-2 text-orange-600 font-black uppercase text-xs tracking-widest pt-4">
        ...
        {screen === 'theory' && (
          <motion.div key="theory" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
             <div className="pt-24 pb-8 text-center sm:text-left max-w-4xl mx-auto px-6">
                ...
                <h2 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter text-slate-900 leading-tight">Տեսություն և <br/><span className="text-blue-600">Խոնարհումներ</span></h2>
             </div>
             <TransportTheory />
          </motion.div>
        )}
        ...
        {screen === 'game' && (
          <motion.div key="game" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
             <div className="pt-24 pb-8 text-center sm:text-left max-w-4xl mx-auto px-6">
                ...
                <h2 className="text-4xl sm:text-6xl font-black italic uppercase tracking-tighter text-slate-900 leading-tight">Մրցակցային <br/><span className="text-orange-600">Խաղ</span></h2>
             </div>
             <TransportGame />
          </motion.div>
        )}
